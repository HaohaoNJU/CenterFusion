...
ROOT_DIR = "/mnt/perception/nuscenes"
...
# ####################################################################################################
    ...
    if opt.save_results:
        ...
        pkl.dump(pre_annos, 
                            open(opt.save_dir + '/save_annos_{}{}.json'.format(
                                opt.test_dataset, opt.dataset_version), 'wb'))
#     results = json.load(open("/mnt/Perception/wanghao/CenterFusion/src/lib/../../exp/ddd/centerfusion/save_results_nuscenes.json","r"))
