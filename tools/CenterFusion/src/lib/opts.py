...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument("--export_onnx", action="store_true",default=False)
    #############################################################
    ...
    self.parser.add_argument('--val_split', default='val',
                             choices=['val','mini_val','test',"val_sub0.1",'val_top1000'])
  ...
  def parse(self, args=''):
    ...
    # TODO : data dir changed here ! 
    #opt.data_dir = os.path.join(opt.root_dir, 'data')
    opt.data_dir = "/mnt/Perception/nuscenes/"
